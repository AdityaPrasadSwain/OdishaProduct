            ...
            {ecoCard.map((product, index) => (
                <Grid
                    ...
                    <BlankCard>
                        ...
                        <CardContent sx={{ p: 3, pt: 2, background: 'rgba(17, 25, 40, 0.5)' }}>
                            <Typography variant="h6" sx={{ color: '#F8FAFC', mb: 1 }}>{product.title}</Typography>
                            <Stack direction="row" alignItems="center" justifyContent="space-between" mt={1}>
                                <Stack direction="row" alignItems="center" spacing={1}>
                                    <Typography variant="h6" color="primary.main" sx={{ fontWeight: 700 }}>
                                        ${product.price}
                                    </Typography>
                                    <Typography color="textSecondary" sx={{ textDecoration: 'line-through', fontSize: '0.85rem' }}>
                                        ${product.salesPrice}
                                    </Typography>
                                </Stack>
                                <Rating name="read-only" size="small" value={product.rating} readOnly sx={{ color: '#FBBF24' }} />
                            </Stack>
                        </CardContent>
                    </BlankCard>
                </Grid>
