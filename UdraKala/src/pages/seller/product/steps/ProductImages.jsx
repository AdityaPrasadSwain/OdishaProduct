...
const ProductImages = ({ productId, onNext, onBack }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in-up">
            <h3 className="text-lg font-bold text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">Product Images</h3>
            ...
            <div className="flex gap-4">
                <input
                    ...
                    className="flex-1 px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none bg-gray-50 dark:bg-gray-800 focus:bg-white dark:focus:bg-gray-700 dark:text-gray-100 placeholder-gray-400"
                />
                <button
                    type="button"
                    onClick={handleAdd}
                    className="px-6 py-3 bg-gray-800 dark:bg-gray-700 text-white font-bold rounded-xl hover:bg-black dark:hover:bg-gray-600 transition-all"
                >
                    Add
                </button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                {urls.map((url, idx) => (
                    <div key={idx} className="relative group rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 aspect-square bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
