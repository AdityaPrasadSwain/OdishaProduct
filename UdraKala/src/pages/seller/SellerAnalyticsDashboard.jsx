...
const SellerAnalyticsDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-bg-page dark:bg-[#1B1A3A] text-text-primary dark:text-text-onDark p-6 md:p-8 font-sans transition-colors duration-300">
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                <div>
                    ...
                    <p className="text-text-secondary dark:text-text-secondary text-sm mt-1">Real-time Overview • {new Date().toLocaleString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <DashboardCard className="relative overflow-hidden group">
                    <div className="flex justify-between items-start z-10 relative">
                        <div>
                            <p className="text-text-secondary dark:text-text-secondary text-sm">Total Sales (Today)</p>
                            <h2 className="text-3xl font-bold mt-1 text-text-primary dark:text-text-onDark">{formatINR(125400)}</h2>
                ...
                <DashboardCard>
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-text-secondary dark:text-text-secondary text-sm">Orders (Today)</p>
                ...
                <DashboardCard>
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-text-secondary dark:text-text-secondary text-sm">Net Profit (Monthly)</p>
                            ...
                            <p className="text-text-secondary dark:text-text-secondary text-xs mt-2">
                                Margin: <span className="text-text-primary dark:text-text-onDark font-bold">22%</span>
                            </p>
                        </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-border dark:border-transparent dark:shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex items-center justify-between text-xs">
                        <span className="text-text-secondary dark:text-text-secondary">Previous: {formatINR(925000)}</span>
                ...
                <DashboardCard title="P&L Statement (Monthly)" className="lg:col-span-1 border-l-4 border-l-teal-500">
                    <div className="space-y-3">
                        <div className="flex justify-between text-sm py-2 border-b border-border dark:border-transparent dark:shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)]">
                            <span className="text-text-secondary dark:text-text-secondary">Sales Revenue</span>
                            <span className="text-text-primary dark:text-text-onDark font-medium">{formatINR(125400)}</span>
                        </div>
                        <div className="flex justify-between text-sm py-1">
                            <span className="text-status-error dark:text-red-400">Platform Fees</span>
                            <span className="text-status-error dark:text-red-400">-{formatINR(10000)}</span>
                        </div>
                        <div className="flex justify-between text-sm py-1">
                            <span className="text-status-error dark:text-red-400">Packaging</span>
                            <span className="text-status-error dark:text-red-400">-{formatINR(2500)}</span>
                        </div>
                        <div className="flex justify-between text-sm py-1">
                            <span className="text-status-error dark:text-red-400">Shipping</span>
                            <span className="text-status-error dark:text-red-400">-{formatINR(8000)}</span>
                        </div>
                        <div className="flex justify-between text-sm py-1">
                            <span className="text-status-error dark:text-red-400">Warehouse</span>
                        ...
                        <div className="flex justify-between text-sm py-1 border-b border-border dark:border-transparent dark:shadow-xl dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] pb-2">
                            <span className="text-status-error dark:text-red-400">Gateway Fees</span>
                            <span className="text-status-error dark:text-red-400">-{formatINR(1200)}</span>
                        </div>
                ...
                <DashboardCard title="Reels Performance" className="lg:col-span-2">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-bg-band dark:bg-bg-dark/20 p-4 rounded-xl">
                            ...
                            <p className="text-xl font-bold text-text-primary dark:text-text-onDark">54</p>
                        </div>
                        <div className="bg-bg-band dark:bg-bg-dark/20 p-4 rounded-xl">
                            <p className="text-xs text-text-secondary mb-1">Total Views</p>
                            <p className="text-xl font-bold text-text-primary dark:text-text-onDark">1.2M</p>
                        </div>
                        <div className="bg-bg-band dark:bg-bg-dark/20 p-4 rounded-xl">
                            <p className="text-xs text-text-secondary mb-1">CTR %</p>
                            <p className="text-xl font-bold text-status-warning dark:text-yellow-400">4.5%</p>
                        </div>
                        <div className="bg-bg-band dark:bg-bg-dark/20 p-4 rounded-xl border border-teal-500/30">
                            <p className="text-xs text-text-secondary mb-1">Sales from Reels</p>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div className="w-40 h-40 relative">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center flex-col pointer-events-none">
                                <span className="text-2xl font-bold text-text-primary dark:text-text-onDark">25</span>
                        ...
                        <div className="flex-1 w-full">
                            <div className="grid grid-cols-2 gap-4 mb-4">
                                <div className="bg-bg-band dark:bg-bg-surface/5 p-3 rounded-lg text-center">
                                    <p className="text-xs text-text-secondary dark:text-text-secondary">Total Refunded</p>
                                    <p className="text-lg font-bold text-status-error dark:text-red-400">{formatINR(5500)}</p>
                                </div>
                                <div className="bg-bg-band dark:bg-bg-surface/5 p-3 rounded-lg text-center">
                                    <p className="text-xs text-text-secondary dark:text-text-secondary">Cancellations</p>
                                    <p className="text-lg font-bold text-text-secondary dark:text-text-onDark">10</p>
                                </div>
                            </div>
